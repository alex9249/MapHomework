...
public class MainActivity extends FragmentActivity
    ...
    private static final LatLng SCHOOL = new LatLng(38.206158, -85.758705);
    private static final LatLng HOME = new LatLng(38.228629, -85.483369);
    private static final LatLng WORK = new LatLng(38.220923, -85.586782);
    ...
    class CustomInfoWindowAdapter implements GoogleMap.InfoWindowAdapter {
        ...
        private void render(Marker marker, View view) {
            ...
            if (marker.equals(mSchool)) {
                badge = R.drawable.badge_qld;
            } else if (marker.equals(mHome)) {
                badge = R.drawable.badge_sa;
            } else if (marker.equals(mWork)) {
    ...
    private Marker mWork;
    private Marker mHome;
    private Marker mSchool;
    ...
    private void addMarkersToMap() {
        ...
        mWork = mMap.addMarker(new MarkerOptions()
                .position(WORK)
                .title("Work")
        ...
        mSchool = mMap.addMarker(new MarkerOptions()
                .position(SCHOOL)
                .title("School")
                .draggable(true));
